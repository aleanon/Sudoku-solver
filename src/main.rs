...
use iced::{keyboard::{key::Named, Key}, theme, widget::{self, button, column, container, row, text}, window::{self}, Application, Command, Length, Settings, Size };
use update::Message;
use styles::ThickRule;
use sudoku::Sudoku;
mod update;
mod sudoku;
mod styles;
...
fn main() {
    let settings = Settings {
        window: window::Settings {
            min_size: Some(Size::new(800., 800.)),
            ...
            match key {
                ...
                Key::Named(named_key) => {
                    match named_key {
                        ...
                        Named::ArrowLeft => Some(Message::Left),
                        Named::ArrowRight => Some(Message::Right),
